...
/// <summary>
/// Required Transformation Tables. 
/// Source https://ru.wikipedia.org/wiki/DES
/// </summary>
internal static class EncryptionScheme
{
    /// <summary>
    /// Table 6. Left cyclic shifts.
    /// </summary>
    public static readonly int[] KeyShifts = 
        { 1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1 };

    /// <summary>
    /// Table 4. permutation of P. 
    /// </summary>
    ...
    /// <summary>
    /// Table 5. Key generation k_i
    /// </summary>
    public static readonly int[] KP1 =
    {
            57, 49, 41, 33, 25, 17, 9,
            1, 58, 50, 42, 34, 26, 18,
            10, 2, 59, 51, 43, 35, 27,
    ...
    /// <summary>
    /// Table 7. Key generation k_i
    /// </summary>
    public static readonly int[] KP2 =
    {
            14, 17, 11, 24, 1, 5,
            3, 28, 15, 6, 21, 10,
            23, 19, 12, 4, 26, 8,
    ...
    /// <summary>
    /// Table 2. Extension function E.
    /// </summary>
    public static readonly int[] EP =
    {
            32, 1, 2, 3, 4, 5,
            4, 5, 6, 7, 8, 9,
            8, 9, 10, 11, 12, 13,
    ...
    /// <summary>
    /// Table 1. Initial IP permutation.
    /// </summary>
    ...
    /// <summary>
    /// Table 8: Reverse transposition of IP^-1
    /// </summary>
    ...
    /// </summary>
    /// 
    public static readonly int[][][] SBox = new int[][][] {
            new int[][] {
